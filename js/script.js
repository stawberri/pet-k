...
(function(){puddi(function(){return this._||(this._={})})}).call(this);
(function(){puddi(function(){var t,e=this;return this.stage=new createjs.Stage("game"),this.barn=new Barn(localStorage),t=createjs.Ticker,t.timingMode=t.RAF_SYNCHED,t.addEventListener("tick",function(t){return e.stage.update(t)}),t})}).call(this);
...
(function(){var t,e,i,n,r;for(t={},e=0,r=(n=this.puddi.mew).length;r>e;++e)i=n[e],i.call(t)}).call(this);
