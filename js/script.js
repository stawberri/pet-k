...
(function(){puddi(function(){return this.$||(this.$={})})}).call(this);
(function(){puddi(function(){var t,i=this;return this.stage=new createjs.Stage("game"),this.barn=new Barn(localStorage),t=createjs.Ticker,t.timingMode=t.RAF_SYNCHED,t.addEventListener("tick",function(t){return i.stage.update(t)}),t})}).call(this);
...
(function(){var t,i,e,n,a;for(t={},i=0,a=(n=this.puddi.mew).length;a>i;++i)e=n[i],e.call(t)}).call(this);
